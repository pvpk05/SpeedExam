...
import { faList, faUsers, faFileContract, faLink, faAward, faFileSignature, faMailBulk, faEdit, faCheck, faTimes } from '@fortawesome/free-solid-svg-icons';
        ...
        <Table>
          <TableHead>
            <TableRow>
              ...
              <TableCell>Hall Ticket Mail</TableCell>
            </TableRow>
          </TableHead>
          <TableBody>
            {currentRegistrations.map((reg) => (
              <TableRow key={reg.ID}>
                ...
                <TableCell style={{ color: reg.SentHallTicketMail === "1" ? "green" : "red", textAlign: "center", fontWeight: "bolder" }}>{reg.SentHallTicketMail === "1" ? <><FontAwesomeIcon icon={faCheck} style={{ width: "14px", marginTop: "4px" }} /> Sent </> : <><FontAwesomeIcon icon={faTimes} style={{ width: "14px", marginTop: "4px" }} /> Not Sent </>}</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
