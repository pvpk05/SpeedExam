                                                    ...
                                                    <MenuItem
                                                        ...
                                                        onClick={() => {
                                                            navigator.clipboard.writeText(
                                                                `http://localhost:5173/register?TId=${exam.examToken}`
                                                            )
                        ...
                        {isCreateMode &&
                            <section>
                                <form onSubmit={handleSubmit} style={{ margin: "auto", padding: "20px", borderRadius: "8px" }}>
                                    ...
                                    <div style={{ display: "flex", gap: "16px" }}>
                                        {/* <TextField sx={{ flex: 2 }} label="No of Questions" type="number" name="noOfQuestions" value={createExam.noOfQuestions} onChange={handleChange} />
