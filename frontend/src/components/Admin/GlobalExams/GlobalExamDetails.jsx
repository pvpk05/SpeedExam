...
import { Box, Menu, MenuItem, Typography, FormControl, OutlinedInput, InputLabel, Select, Table, TableBody, TableCell, TableRow, Stepper, Step, StepLabel, Button, TextField, RadioGroup, FormControlLabel, Radio, FormHelperText } from "@mui/material";
  ...
  return (
    <section>
      <form onSubmit={handleSubmit} style={{ margin: "auto", padding: "20px", borderRadius: "8px" }}>
        ...
        <h5 style={{ fontWeight: "bolder", marginBottom: '15px' }}>Exam Details</h5>
        <div style={{ paddingLeft: "30px", paddingRight: "60px" }}>
          <div style={{ display: "flex", gap: "16px" }}>
            <TextField className='mb-4' sx={{ flex: 2 }} label="Exam Name" name="examName" value={createExam.examName} onChange={handleChange}
          ...
          <div style={{ display: "flex", gap: "20px" }}>
            <TextField fullWidth className='mb-4' sx={{ flex: 2 }} label="Duration (in minutes)" type="number" name="duration"
              value={createExam.duration} error={errors.duration} helperText={errors.duration}
              onChange={(e) => {
            ...
            <LocalizationProvider dateAdapter={AdapterDayjs}>
              <DateTimePicker label="Start Time" sx={{ flex: 2 }} value={dayjs(createExam.examStartTime)}
                ...
                slotProps={{
                  textField: {
                    error: errors.examStartTime, helperText: errors.examStartTime
                  }
                }}
              />
            ...
            <LocalizationProvider dateAdapter={AdapterDayjs}>
              <DateTimePicker label="End Time" sx={{ flex: 2 }} value={dayjs(createExam.examEndTime)}
                ...
                slotProps={{
                  textField: {
                    error: errors.examEndTime, helperText: errors.examEndTime
                  }
                }}
              />
            </LocalizationProvider>
        ...
        <h5 style={{ fontWeight: "bolder", marginTop: "30px", marginBottom: '15px' }}>Question Details</h5>
        ...
        <div style={{ display: "flex", gap: "20px" }}>
          ...
          <TextField
            ...
            error={errors.noOfQuestions} helperText={errors.noOfQuestions}
          />
