...
import { Button, Dialog, DialogContent, Typography, Stack, Divider, DialogTitle, FormControl, InputLabel, MenuItem, Select, Radio, RadioGroup, FormControlLabel, TextField, Checkbox, Paper, IconButton, Menu } from "@mui/material";
...
function Questions({ selectedSection, onBack }) {
  ...
  const handleDelete = async (ID) => {
    try {
      ...
      toast.success(`${ID} deleted successfully: ${response.data.message}`);
      getAllQuestions();
    } catch (error) {
